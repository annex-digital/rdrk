 ...
 *
 * On config export install, no config or dependent config of any excluded module
 * is exported. On config import install, any config of any installed excluded
